    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('films', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='film_ratings', to='films.films')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('films', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='film_likes', to='films.films')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('films', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='film_favorites', to='films.films')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('films', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='film_comments', to='films.films')),
